...
<head>
    ...
    <meta name="description" content="Secure administrative login for UniHub. Authorized personnel access only.">
    <title>Admin Portal Login - UniHub</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <div class="card card-glass border-0 p-4 shadow-lg text-center" style="border-radius: 16px;">
                    <div class="mb-4">
                        <div class="bg-primary text-white rounded-circle p-3 d-inline-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                    ...
                    <form id="adminLoginForm" action="../actions/admin/login.php" method="POST" class="text-start">
                        ...
                        <button type="submit" class="btn btn-primary w-100 py-2.5 fw-semibold btn-animate fs-6">
                            Secure Log In <i class="bi bi-shield-check ms-1"></i>
                        </button>
                    </form>
